...
def _serialize(announcement: Announcement, creator: Profile | None) -> dict[str, Any]:
    return {
        ...
        "event_date": announcement.event_date.isoformat() if getattr(announcement, "event_date", None) else None,
        "image_url": getattr(announcement, "image_url", None),
        "link_url": getattr(announcement, "link_url", None),
